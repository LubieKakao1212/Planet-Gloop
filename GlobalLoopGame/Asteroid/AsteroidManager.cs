...
namespace GlobalLoopGame.Asteroid
{
    public class AsteroidManager : IGameComponent, IUpdateable, IResettable
    {
        ...
        public List<AsteroidWave> waves = new List<AsteroidWave>()
        {
            ...
            {
                new AsteroidPlacement(Vector2.One * 3f, 45f, 45f, 8f, 75)
            },
            0,
            new List<float>()
            {
            ...
            new AsteroidWave(new List<AsteroidPlacement>()
            {
                new AsteroidPlacement(Vector2.One * 3f, 0f, 0f, 8f, 75)
            },
            0,
            new List<float>()
            {
            ...
            new AsteroidWave(new List<AsteroidPlacement>()
            {
                new AsteroidPlacement(Vector2.One * 3f, 180f, 180f, 8f, 75)
            },
            0,
            new List<float>()
            {
            ...
            new AsteroidWave(new List<AsteroidPlacement>()
            {
                new AsteroidPlacement(Vector2.One * 18f, 80f, 100f, 5.4f, 280)
            },
            4,
            new List<float>()
            {
            ...
            new AsteroidWave(new List<AsteroidPlacement>()
            {
                new AsteroidPlacement(Vector2.One * 22f, 270f, 359f, 4.5f, 450)
            },
            10,
            new List<float>()
            {
